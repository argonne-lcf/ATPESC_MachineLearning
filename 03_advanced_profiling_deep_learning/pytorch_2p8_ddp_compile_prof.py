...
prof.export_chrome_trace(f"{args.trace_dir}/xpu_compile_pt_2p8-{RANK}-of-{SIZE}.json")
output_path = f"{args.trace_dir}/xpu_compile_pt_2p8_self_xpu_time_total-{RANK}-of-{SIZE}.txt"
