...
@buffer_for_constant_41 = local_unnamed_addr addrspace(1) constant [4 x i8] zeroinitializer, align 64
@buffer_for_constant_61 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\00\00\80\FF", align 64
@shared_cache_0 = private unnamed_addr addrspace(3) global [1 x [32 x [33 x float]]] undef
@shared_cache_01 = private unnamed_addr addrspace(3) global [2 x [32 x [33 x float]]] undef
@shared_cache_02 = private unnamed_addr addrspace(3) global [1 x [32 x float]] undef
@shared_cache_03 = private unnamed_addr addrspace(3) global [1 x [32 x float]] undef
@shared_cache_04 = private unnamed_addr addrspace(3) global [1 x [32 x float]] undef
...
__nv_powf.exit:                                   ; preds = %__nv_fabsf.exit7.i, %104, %__nv_fabsf.exit19.i, %__nv_isinff.exit23.i, %117
...
__nv_powf.exit30:                                 ; preds = %__nv_fabsf.exit7.i17, %213, %__nv_fabsf.exit19.i23, %__nv_isinff.exit23.i25, %226
...
reduce-group-0-after:                             ; preds = %output_y_in_tile.loop_exit, %reduction_atomic_update-true
  ret void
...
reduce-group-0-after:                             ; preds = %reduction_atomic_update-after, %reduction_atomic_update-true41
  ret void
...
reduce-group-0-after:                             ; preds = %intra_warp_reduce_write-after, %reduction_atomic_update-true
  ret void

loop_z.loop_exit:                                 ; preds = %loop_z.loop_header.critedge.us.6, %output_x_in_tile-true29.us.7, %entry.split, %loop_z.loop_body.us108.preheader
...
loop.loop_body:                                   ; preds = %entry, %fusion.35.in_bounds-after
...
loop_z.loop_body.us:                              ; preds = %loop_z.loop_body.us.preheader, %loop_z.loop_header.critedge.us
...
reduce-group-0-after:                             ; preds = %inter_warp_reduce-true, %reduction_atomic_update-true, %intra_warp_reduce_write-after
  ret void
...
loop_z.loop_exit:                                 ; preds = %loop_z.loop_header.critedge.us, %loop_z.loop_header.critedge.6, %output_x_in_tile-true59.7
...
loop.loop_body:                                   ; preds = %entry, %fusion.34.in_bounds-after
...
fusion.59.in_bounds-after:                        ; preds = %slice3-true, %slice2-after.thread, %slice6-true, %slice9-true, %entry
  ret void
