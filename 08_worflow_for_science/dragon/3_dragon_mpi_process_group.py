...
exe = "/flare/ATPESC2026/EXAMPLES/track-6-workflows-for-science/GettingStarted/Examples/Aurora/affinity_gpu/sycl/hello_affinity" # Path to MPI executable for Aurora
