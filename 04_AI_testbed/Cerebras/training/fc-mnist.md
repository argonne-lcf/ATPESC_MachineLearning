...
```bash
cd ~/R_2.4.0/modelzoo/modelzoo/fc_mnist/pytorch
```

Activate PyTroch virtual Environment 
```bash
source ~/R_2.4.0/venv_pt/bin/activate
```
...
python run.py CSX --job_labels name=pt_smoketest --params configs/params.yaml --num_csx=1 --mode train --model_dir $MODEL_DIR --mount_dirs /home/ /software --python_paths /home/$(whoami)/R_2.4.0/modelzoo --compile_dir /$(whoami) |& tee mytest.log
```
<details>
